...
For trainers and instructors delivering this lab:
...
✔ Able to enable/verify logs
✔ Able to read metrics
✔ Able to configure alarms
✔ Able to receive notifications
✔ Able to trigger autoscaling events
✔ Able to troubleshoot errors

### **Common Student Pitfalls**

* Forgetting to select compartment in Metrics Explorer
* Unified Agent not installed or disabled
* Wrong metric namespace in alarm query
* Notifications not confirmed
